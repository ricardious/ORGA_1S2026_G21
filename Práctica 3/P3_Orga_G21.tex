...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.42\textwidth}
        \centering
        \includegraphics[width=\textwidth]{assets/proteus_modulo_temporizacion_secuencia_general.png}
...
En particular, se utilizó una compuerta NAND de 4 entradas porque era necesario tomar en cuenta el estado completo del contador y no únicamente uno o dos bits aislados. Esa compuerta recibe las cuatro líneas del bloque descendente y las resume en una sola señal de control. Luego, esa salida se combina con la lógica de reloj para generar \texttt{LOAD\_10}, que fuerza el patrón 1010 al inicio de la fase roja. El uso de una NAND resulta conveniente porque entrega una salida negada, útil para este tipo de señales de carga y detección en lógica TTL, y evita construir la misma condición con varias compuertas más pequeñas.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{assets/proteus_contador_ascendente_0_a_15.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{assets/proteus_modulo_control_motor_dc_carrusel.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.36\textwidth]{assets/armado_fisico_prueba_motor_y_cableado.jpeg}
    \caption{Prueba física del motor y verificación del cableado de accionamiento.}
\end{figure}
